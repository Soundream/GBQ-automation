...
def run_key_brand_1(start_date=None, end_date=None, yyyymm=None, output_folder=""):
    ...
    if output_folder:
        if yyyymm:
            output_path = f"{output_folder}/{yyyymm}_dedup_audience.csv" 
        else:
            output_path = f"{output_folder}/dedup_audience.csv" 
    else:
        if yyyymm:
            output_path = f"{yyyymm}_dedup_audience.csv" 
        else:
            output_path = "dedup_audience.csv"
